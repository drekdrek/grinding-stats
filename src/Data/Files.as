class Files : AbstractData {
    ...
    void load() override {
        ...
        debug_print("Read finishes " + finishes + " resets " + resets + " time " + time + " respawns " + respawns + " from " + file_location);
    }
    ...
    void save() override {
        ...
        debug_print("Wrote finishes " + finishes + " resets " + resets + " time " + time + " respawns " + respawns + " to " + file_location);
    }
}