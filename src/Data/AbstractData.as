abstract class AbstractData {
    ...
    void set_time(uint64 _time) {
        time = _time;
    }
    void set_finishes(uint64 _finishes) {
        finishes = _finishes;
    }
    void set_resets(uint64 _resets) {
        resets = _resets;
    }
    void set_respawns(uint64 _respawns) {
        respawns = _respawns;
    }
    void set_medals(Json::Value _medals) {
        medals = _medals;
    }
